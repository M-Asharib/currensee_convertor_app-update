...
class _CurrencyListState extends State<CurrencyList> {
  ...
  void initState() {
    ...
    searchController.addListener(() {
      filterCurrencies(searchController.text);
    });
  }
  ...
  Future<void> fetchCurrencies() async {
    ...
    if (response.statusCode == 200) {
      ...
      // Convert to list of maps with rates
      final List<Map<String, dynamic>> currencyList = rates.entries
          .map((entry) => {
                'code': entry.key,
                'rate': entry.value,
      ...
      setState(() {
        ...
        filteredCurrencies = currencyList; // Initially, show all
      });
    } else {
  ...
  String getCurrencyName(String code) {
    ...
    const currencyNames = {
      ...
      'FOK': 'Faroese Króna', // Complete the name for FOK
